...
def generate_launch_description():
    ...
    gazebo_resource_path = SetEnvironmentVariable(
        ...
        value = [str(Path(get_package_share_directory("skyrn_description")).parent.resolve())]
    )
    ...
    return LaunchDescription([model_arg, robot_state_publisher, gazebo_resource_path, gazebo , gz_spawn_entity])
